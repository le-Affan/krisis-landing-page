...
export default function HeroSection() {
  ...
  return (
    <section ref={ref} className="relative min-h-screen flex items-center pt-24 pb-16 px-8 overflow-hidden bg-transparent" style={{ perspective: 1200 }}>
      ...
      <div className="max-w-7xl mx-auto w-full grid lg:grid-cols-2 gap-16 lg:gap-24 items-center relative z-10" style={{ transformStyle: 'preserve-3d' }}>
        ...
        <div className="relative z-20" style={{ transformStyle: 'preserve-3d', transform: 'translateZ(30px)' }}>
          ...
          <motion.h1
            ...
            className="text-[3.2rem] lg:text-[4.2rem] font-bold leading-[1.05] tracking-tight text-white mb-6 transform-gpu"
          >
            <span className="whitespace-nowrap text-white">Your Model Improved?</span><br />
          ...
          <motion.p
            ...
            className="text-lg text-slate-300/90 leading-relaxed mb-10 max-w-lg font-light transform-gpu"
          >
          ...
          >
            <motion.button
              ...
              className="bg-white text-slate-900 px-8 py-3.5 rounded-xl font-semibold text-base shadow-[0_0_20px_rgba(255,255,255,0.1)] hover:shadow-[0_0_30px_rgba(255,255,255,0.25)] transition-shadow duration-300"
              whileTap={{ scale: 0.96 }}
            >
              Try Live Demo
            </motion.button>
            <motion.button
              onClick={() => window.open("https://github.com/le-Affan/krisis", "_blank")}
              className="glass-panel text-white px-8 py-3.5 rounded-xl font-medium text-base hover:bg-[#252b48]/60 border border-white/5 hover:border-white/15 transition-all duration-300"
              whileTap={{ scale: 0.96 }}
            >
              View GitHub
            </motion.button>
        ...
        >
          ...
          <motion.div
            className="relative w-full max-w-md rounded-2xl border border-indigo-400/15 bg-gradient-to-b from-[#0f1428]/90 to-[#080b1a]/90 backdrop-blur-2xl shadow-2xl overflow-hidden flex flex-col p-6"
            animate={{
              y: [0, -10, 5, -7, 0],
              x: [0, 3, -5, 3, 0],
              rotateX: [0, 2, -1, 2, 0],
          ...
          >
            ...
            <div className="flex items-center gap-2.5 mb-6 relative z-10">
              <div className="relative flex items-center justify-center">
                <span className="absolute w-3 h-3 rounded-full bg-cyan-400 animate-ping opacity-50" />
                <span className="relative w-2 h-2 rounded-full bg-cyan-400" />
              </div>
              <span className="text-[0.65rem] uppercase tracking-widest text-slate-400 font-semibold">Session Active · Routing Traffic</span>
            </div>
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[120%] h-[120%] bg-indigo-500/5 blur-[120px] rounded-full -z-10" style={{ transform: 'translateZ(-100px)' }} />
        </motion.div>
      </div>
    </section>
  );
